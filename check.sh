...
done <<<$(cat $ENERGI_TMP | egrep "isActive:|isAlive:|miner:|staking:|balance:|balance_changed:|balance_delta:|height:|totalWeight:|announcedBlock:|swFeatures:|swVersion:|eth_block_number:" | egrep -v "modules")
rm $ENERGI_TMP
